...
<body>
    ...
    <section class="bg-contact">
        ...
        <div class="d-flex justify-content-center ">
            <div class="contactme">
                <h2>CONTACT ME</h2>
                <p>All your smiles and laughter I'll keep it in my photos</p>
            </div>
        </div>
    ...
    <section class="contact">
        <div class="container">
            ...
            <div class="percengrey">
                ...
                <p class="sc-con">
                    <span><a
                            href="https://www.facebook.com/18percentgrey.studio"
                            target="_black">
                            <svg
                    ...
                    <span>
                        <a href="https://lin.ee/Zcqllhi" target="_blank">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="16"
                                height="16"
                    ...
                    <span>
                        <a
                            href="https://www.instagram.com/18PercentGrey.Studio/"
                            target="_blank">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="16"
            ...
            <div>
                <p>
                    Thank you very much for your appreciation and interest in our team.
                    Providing Photography, Videography, and Photo booth services for
                    Weddings, Events and Various ceremonies.
                </p>
            </div>
        </div>
